...
const dgzTranslations = {
    en: {
        ...
        sector_infra_h: "Engineering & Infrastructure",
        sector_infra_p: "We provide precise spatial telemetry for mega-project tracking and technical supervision with continuous GIS integration.",
        sector_consult_h: "Consulting Firms",
        sector_consult_p: "We automate satellite imagery processing and raster data for environmental studies and territorial change detection.",
        // Banner
        banner_title: "Ready to scale your spatial infrastructure?",
        banner_desc: "Schedule a technical session today and optimize your territorial data workflows.",
        // Engagement
        eng_label: "// STRATEGIC_ENGAGEMENT",
        eng_title: "Collaboration Models",
        eng_desc: "We offer comprehensive solutions tailored to your territorial project's scale.",
        // Contact
        contact_title: "START PROJECT.",
    ...
    es: {
        ...
        sector_infra_h: "Ingeniería e Infraestructura",
        sector_infra_p: "Proporcionamos telemetría espacial precisa para el seguimiento de megaproyectos y supervisión técnica con integración GIS continua.",
        sector_consult_h: "Empresas de Consultoría",
        sector_consult_p: "Automatizamos el procesamiento de imágenes satelitales y datos ráster para estudios ambientales y detección de cambios territoriales.",
        // Banner
        banner_title: "¿Listo para escalar su infraestructura espacial?",
        banner_desc: "Agende una sesión técnica hoy mismo y optimice sus flujos de datos territoriales.",
        // Engagement
        eng_label: "// COMPROMISO_ESTRATÉGICO",
        eng_title: "Modelos de Colaboración",
        eng_desc: "Ofrecemos soluciones integrales adaptadas a la escala de su proyecto territorial.",
        // Contact
        contact_title: "INICIAR PROYECTO.",
